...
3. Build an install URL with **Send Messages** permission (`permissions=2048`) and both `bot` + `applications.commands` scopes (the latter is required for slash commands):
   ```
