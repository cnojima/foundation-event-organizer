...
const DEFAULT_TEMPLATES = [
  ...
  },
  {
    ...
    eventName: "Arms Race - Stage A",
    description:
      "Participate in the Arms Race event near the Commerce Guild Hub. Defeat powerful enemies arranged by the Galactic Trade Consortium to earn valuable rewards.",
    kind: "simple" as const,
    squad1Name: "Squad 1",
    squad2Name: "Squad 2",
    maxPlayers: 20,
    ...
    {
    templateName: "Arms Race - Stage B",
    eventName: "Arms Race - Stage B",
    description:
      "Participate in the Arms Race event near the Commerce Guild Hub. Defeat powerful enemies arranged by the Galactic Trade Consortium to earn valuable rewards.",
    kind: "simple" as const,
    squad1Name: "Squad 1",
    ...
    {
    templateName: "Defend the Trade Route",
    eventName: "Defend the Trade Route",
    description:
      "EVENT RULES\nThe Ascendancy has set its sights on the Commerce Guild's cargo dreadnought! Defeat their forces and escort the dreadnought to their destinations!\n\nEVENT REWARDS\nDestroy as many enemy fleets as you can! The more fleets you take down, the greater your rewards!",
    kind: "simple" as const,
    squad1Name: "Squad 1",
    squad2Name: "Squad 2",
    maxPlayers: 20,
